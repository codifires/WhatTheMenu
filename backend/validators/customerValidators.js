...
const placeOrderValidator = [
  ...
  body('payment_method').isIn(['cash', 'upi', 'online']).withMessage('Payment method must be cash, upi, or online'),
  body('payment_transaction_id').optional({ checkFalsy: true }).isString().isLength({ max: 50 }),
