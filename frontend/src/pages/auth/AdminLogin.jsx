    ...
    <div style={{ minHeight: '100vh', background: '#080c14', display: 'flex', fontFamily: "'Inter', sans-serif" }}>
      ...
      <div style={{ display: 'none', flex: 1, background: 'linear-gradient(145deg, #1a0a3c 0%, #0f0a28 50%, #080c14 100%)', padding: 48, flexDirection: 'column', justifyContent: 'space-between', borderRight: '1px solid rgba(124,58,237,0.15)' }} className="admin-left-panel">
        <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
          ...
          <span style={{ fontSize: 20, fontWeight: 800, color: '#fff', fontFamily: "'Outfit',sans-serif" }}>QRMenu <span style={{ color: '#a78bfa' }}>Admin</span></span>
        </div>
        <div>
          ...
          <h2 style={{ fontSize: 32, fontWeight: 900, color: '#fff', margin: '0 0 16px', fontFamily: "'Outfit',sans-serif", lineHeight: 1.2 }}>Super Admin<br/>Control Panel</h2>
          <p style={{ fontSize: 15, color: '#6b7280', lineHeight: 1.7 }}>Manage all cafés, subscriptions, and platform settings from one powerful admin interface.</p>
        ...
        <div style={{ width: '100%', maxWidth: 420, position: 'relative', zIndex: 1 }}>
          ...
          <div style={{ marginBottom: 36 }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 20 }}>
              ...
              <div>
                ...
                <h1 style={{ fontSize: 24, fontWeight: 900, color: '#fff', margin: 0, fontFamily: "'Outfit',sans-serif" }}>Admin Portal</h1>
              </div>
            </div>
            <p style={{ fontSize: 14, color: '#6b7280', margin: 0 }}>Sign in to manage the platform. Restricted access only.</p>
          </div>
          ...
          <div style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: 20, padding: 32 }}>
            <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
              {/* Email */}
              <div>
                <label style={{ fontSize: 13, fontWeight: 600, color: '#d1d5db', display: 'block', marginBottom: 8 }}>Admin Email</label>
                <div style={{ position: 'relative' }}>
                  <span style={{ position: 'absolute', left: 14, top: '50%', transform: 'translateY(-50%)', fontSize: 16 }}>📧</span>
                  <input
                    type="email" value={email} onChange={e => setEmail(e.target.value)}
                    placeholder="admin@qrmenu.com" autoComplete="email" required
                    style={{ width: '100%', padding: '12px 14px 12px 42px', borderRadius: 12, border: '1px solid rgba(255,255,255,0.1)', background: 'rgba(255,255,255,0.05)', color: '#fff', fontSize: 14, outline: 'none', boxSizing: 'border-box', transition: 'border-color 0.2s' }}
              ...
              <div>
                ...
                <div style={{ position: 'relative' }}>
                  ...
                  <input
                    ...
                    style={{ width: '100%', padding: '12px 44px 12px 42px', borderRadius: 12, border: '1px solid rgba(255,255,255,0.1)', background: 'rgba(255,255,255,0.05)', color: '#fff', fontSize: 14, outline: 'none', boxSizing: 'border-box', transition: 'border-color 0.2s' }}
                    onFocus={e => e.target.style.borderColor='rgba(124,58,237,0.6)'}
                    onBlur={e => e.target.style.borderColor='rgba(255,255,255,0.1)'}
                  />
              ...
              <button type="submit" disabled={loading}
                style={{ width: '100%', padding: '14px', borderRadius: 12, border: 'none', cursor: loading ? 'not-allowed' : 'pointer', fontSize: 15, fontWeight: 700, color: '#fff', background: 'linear-gradient(135deg,#7c3aed,#4f46e5)', boxShadow: '0 8px 24px rgba(124,58,237,0.4)', opacity: loading ? 0.7 : 1, transition: 'transform 0.2s, box-shadow 0.2s', marginTop: 4 }}
