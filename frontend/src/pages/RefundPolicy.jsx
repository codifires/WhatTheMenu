  ...
  return (
    <div style={{ minHeight: '100vh', background: '#0a0a0f', color: '#e5e7eb', fontFamily: "'Inter', sans-serif" }}>
      ...
      <div style={{ maxWidth: 900, margin: '0 auto', padding: '48px 24px 80px' }}>
        ...
        <h1 style={{ fontSize: 36, fontWeight: 900, fontFamily: "'Outfit', sans-serif", color: '#fff', margin: '0 0 8px' }}>Refund & Cancellation Policy</h1>
        ...
        <div style={{ lineHeight: 1.8, fontSize: 15, color: '#d1d5db' }}>
          ...
          <Section title="2. SaaS Subscriptions (For Café Owners)">
            ...
            <h3 style={{ fontSize: 16, fontWeight: 700, color: '#fff', margin: '16px 0 8px' }}>2.1 Subscription Cancellations</h3>
            ...
            <h3 style={{ fontSize: 16, fontWeight: 700, color: '#fff', margin: '16px 0 8px' }}>2.2 Refund Eligibility for Subscriptions</h3>
            <ul style={{ paddingLeft: 20 }}>
          ...
          <Section title="3. Food Orders (For Customers)">
            ...
            <h3 style={{ fontSize: 16, fontWeight: 700, color: '#fff', margin: '16px 0 8px' }}>3.2 Refunds for Food Orders</h3>
            <ul style={{ paddingLeft: 20 }}>
