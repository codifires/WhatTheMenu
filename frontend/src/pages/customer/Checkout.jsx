...
const Checkout = () => {
  ...
  // Primary action button: Initiates real-time payment session on backend
  const handleProceed = async () => {
    if (!cafe?.upi_id) {
      toast.error('This café has not set up a UPI ID yet. Please notify café staff.')
      return
    }
    ...
    <div style={{ padding: '20px 16px', animation: 'fadeIn 0.4s ease', paddingBottom: 130, maxWidth: 500, margin: '0 auto' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 14, marginBottom: 20 }}>
        ...
        <div>
          ...
          <p style={{ fontSize: 13, color: '#9ca3af', margin: 0 }}>Review table & payment method</p>
        </div>
      </div>
        ...
        {paymentIncomplete && (
          <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
              ...
              <div>
                <p style={{ fontSize: 13, fontWeight: 800, color: '#f87171', margin: 0 }}>Payment Not Completed</p>
                <p style={{ fontSize: 11, color: '#9ca3af', margin: '2px 0 0' }}>Your cart is saved. Tap Repay to complete order.</p>
              </div>
            </div>
            <button
              ...
              style={{
                ...
                boxShadow: '0 2px 10px rgba(245,158,11,0.35)', whiteSpace: 'nowrap'
              }}
            >
              🔄 Repay Now
            </button>
        ...
        <div style={{ background: 'linear-gradient(145deg, rgba(255,255,255,0.03) 0%, rgba(255,255,255,0.01) 100%)', border: '1px solid rgba(255,255,255,0.07)', borderRadius: 24, padding: 20, boxShadow: '0 4px 20px rgba(0,0,0,0.2)' }}>
          ...
          >
            <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
              <div style={{ width: 44, height: 44, borderRadius: 14, background: 'rgba(245,158,11,0.2)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 22 }}>
                ⚡
              </div>
              <div>
                <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
                  <p style={{ fontSize: 15, fontWeight: 800, color: '#fbbf24', margin: 0 }}>Direct NPCI UPI</p>
                  <span style={{ fontSize: 9, fontWeight: 800, background: 'rgba(16,185,129,0.2)', color: '#34d399', padding: '2px 6px', borderRadius: 4 }}>0% Fee</span>
                </div>
                <p style={{ fontSize: 12, color: '#9ca3af', margin: '2px 0 0' }}>GPay, PhonePe, Paytm, BHIM</p>
              </div>
            </div>

            <div style={{ width: 24, height: 24, borderRadius: 50, background: '#f59e0b', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#000', fontSize: 13, fontWeight: 900 }}>
              ✓
            </div>
          </div>
        </div>
      ...
      {/* ── Fixed Bottom Checkout Dock (Modern Full-Width Bar) ── */}
      <div style={{
      ...
      {showUpiModal && (
        <div style={{ position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.85)', backdropFilter: 'blur(10px)', zIndex: 200, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '20px 16px', animation: 'fadeIn 0.3s ease' }}>
          <div style={{ background: '#131722', border: '1px solid rgba(245,158,11,0.3)', borderRadius: 28, padding: 24, maxWidth: 380, width: '100%', textAlign: 'center', boxShadow: '0 25px 60px rgba(0,0,0,0.9)', position: 'relative' }}>
              ...
              <div style={{ marginBottom: 14 }}>
                <button
                  ...
                  style={{
                    ...
                    background: 'linear-gradient(135deg, #3b82f6, #1d4ed8)', color: '#fff', fontSize: 14, fontWeight: 800,
            ...
            <div style={{
              ...
              <div>
                ...
                <p style={{ fontSize: 11, color: '#9ca3af', margin: '2px 0 0', lineHeight: 1.3 }}>
                  Pay via QR or App. Your order will be confirmed automatically!
                </p>
              </div>
            </div>
